...
How to use the OPC UA Test Server Suite in your project's CI/CD pipeline.
...
|---|---|---|
| `image-tag` | `latest` | Docker image tag. Use `latest` for newest, or pin a version like `v1.1.4` |
...
| `legacy-security` | 4847 | `opc.tcp://localhost:4847/UA/TestServer` |
